      ...
      try {
        ...
        if (categoryData) {
          ...
          if (Array.isArray(productsData) ) {
            ...
            const brands = [...new Set(productObjects.map((p) => p.name.split(" ")[0]))]
            setAvailableBrands(brands)

            const highestPrice = Math.max(...productObjects.map((p) => p.price), 1000)
    ...
    <div className="max-w-7xl mx-auto px-4 lg:px-8 py-8 mt-24 md:mt-12">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="hidden lg:block w-64 flex-shrink-0">
          <div className="bg-white rounded-xl shadow-xs border border-gray-100 p-5 sticky top-24">
