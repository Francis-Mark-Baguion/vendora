...
import { getOrderDetails, getOrderItems } from "@/lib/orderQueries";

interface OrderConfirmationClientProps {
    orderId: string;
    initialOrderData?: OrderDetails | null;
}
...
export function OrderConfirmationClient({
  ...
  const { user } = useUser();
  const [order, setOrder] = useState<OrderDetails | null>(initialOrderData);
    ...
    const fetchOrderDetails = async () => {
      ...
      try {
        ...
        // Get order with address
          const { data: orderData, error: orderError } = await getOrderDetails(
              orderId);
